/*
  ...
  - You are about to alter the column `week_day` on the `habit_week_days` table. The data in that column could be lost. The data in that column will be cast from `DateTime` to `Int`.
